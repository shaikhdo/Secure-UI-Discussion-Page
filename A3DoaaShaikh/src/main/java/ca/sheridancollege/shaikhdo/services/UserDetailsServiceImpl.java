package ca.sheridancollege.shaikhdo.services;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		//find the user based on username (read email)
		ca.sheridancollege.shaikhdo.beans.User user = da.findUserAccount(username);
	...
	//Change the list of the user's roles into a list of Granted Authority
